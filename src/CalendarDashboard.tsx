...
function CalendarDashboard() {
  ...
  const handleReservationSubmit = (
    ...
    if (data.id) {
      ...
      const maybeFirstSchedule =
        data.schedules && data.schedules.length > 0 ? data.schedules[0] : null;
      const updated = {
        id: data.id,
        title:
          data.nome ||
          (maybeFirstSchedule ? maybeFirstSchedule.roomName : "Reserva"),
        start: maybeFirstSchedule
          ? `${maybeFirstSchedule.data}T${maybeFirstSchedule.horaInicio}`
          : undefined,
        end: maybeFirstSchedule
          ? `${maybeFirstSchedule.data}T${maybeFirstSchedule.horaFim}`
          : undefined,
      ...
      console.log(
        "Criar nova reserva (implemente inclusão no calendário se desejar):",
        data
      );
      setLastReservation(null);
      setShow(false);
  ...
  const mockPeople: Person[] = [
    ...
    },
    {
      id: "p6",
      name: "Camila Costa",
      email: "camila.costa@empresa.com.br",
      grade: "Aluna",
    },
    {
      id: "p7",
      name: "Felipe Mendes",
      email: "felipe.mendes@empresa.com.br",
      grade: "Professor",
    },
    {
      id: "p8",
      name: "Larissa Rocha",
      email: "larissa.rocha@empresa.com.br",
      grade: "Aluna",
    },
    {
      id: "p9",
      name: "Gustavo Almeida",
      email: "gustavo.almeida@empresa.com.br",
      grade: "Professor",
    },
    {
      id: "p10",
    ...
    },
    {
      id: "p11",
      name: "Daniel Martins",
      email: "daniel.martins@empresa.com.br",
      grade: "Aluno",
    },
    {
      id: "p12",
    ...
    },
    {
      ...
      email: "eduardo.fernandes@empresa.com.br",
      grade: "Professor",
    },
    {
      id: "p14",
      name: "Viviane Barbosa",
      email: "viviane.barbosa@empresa.com.br",
      grade: "Professora",
    },
    {
      id: "p15",
    ...
    },
    {
      id: "p16",
      name: "Juliana Dias",
      email: "juliana.dias@empresa.com.br",
      grade: "Aluna",
    },
    {
      id: "p17",
    ...
    },
    {
      id: "p18",
      name: "Isabela Pires",
      email: "isabela.pires@empresa.com.br",
      grade: "Professora",
    },
    {
      id: "p19",
      name: "Lucas Nogueira",
      email: "lucas.nogueira@empresa.com.br",
      grade: "Aluno",
    },
    {
      id: "p20",
      name: "Amanda Ribeiro",
      email: "amanda.ribeiro@empresa.com.br",
      grade: "Aluna",
    },
    {
      id: "p21",
      name: "Thiago Borges",
      email: "thiago.borges@empresa.com.br",
      grade: "Professor",
    },
    {
      id: "p22",
      name: "Renata Cunha",
      email: "renata.cunha@empresa.com.br",
      grade: "Professora",
    },
    {
      id: "p23",
      name: "Marcelo Viana",
      email: "marcelo.viana@empresa.com.br",
      grade: "Aluno",
    },
    {
      id: "p24",
      name: "Sofia Moraes",
      email: "sofia.moraes@empresa.com.br",
      grade: "Aluna",
    },
    {
      id: "p25",
      name: "Paulo Castro",
      email: "paulo.castro@empresa.com.br",
      grade: "Professor",
    },
    {
      id: "p26",
      name: "Érica Vaz",
      email: "erica.vaz@empresa.com.br",
      grade: "Professora",
    },
    {
      id: "p27",
      name: "Guilherme Rosa",
      email: "guilherme.rosa@empresa.com.br",
      grade: "Aluno",
    },
    {
      id: "p28",
      name: "Helena Torres",
      email: "helena.torres@empresa.com.br",
      grade: "Aluna",
    },
    {
      id: "p29",
      name: "Vinícius Melo",
      email: "vinicius.melo@empresa.com.br",
      grade: "Professor",
    },
    {
      id: "p30",
      name: "Clara Neves",
      email: "clara.neves@empresa.com.br",
      grade: "Professora",
    },
  ];
